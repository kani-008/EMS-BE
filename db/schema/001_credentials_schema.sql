-- ============================================================================
-- SCHEMA: credentials  (Authentication Only)
-- Run against your single Supabase database, after 000_schemas.sql.
-- (psql "$DATABASE_URL" -f 001_credentials_schema.sql)
-- ============================================================================

-- ============================================================================
-- Table: table_login  (User authentication and role assignment)
-- ============================================================================
CREATE TABLE IF NOT EXISTS credentials.table_login (
...
CREATE INDEX IF NOT EXISTS idx_table_login_user_name     ON credentials.table_login (user_name);
CREATE INDEX IF NOT EXISTS idx_table_login_department_id ON credentials.table_login (department_id);
CREATE INDEX IF NOT EXISTS idx_table_login_status         ON credentials.table_login (status);

DROP TRIGGER IF EXISTS trg_table_login_updated ON credentials.table_login;
CREATE TRIGGER trg_table_login_updated
  BEFORE UPDATE ON credentials.table_login
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS credentials.table_role (
...
-- ============================================================================
INSERT INTO credentials.table_login (user_name, password, user_role_id, department_id, status)
